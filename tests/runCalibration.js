...
const checks = [
  ...
  ["v33.1 capital language softening present", capitalLanguage.includes("softenCapitalVerdict") && (capitalLanguage.includes("Fresh allocation not favoured") || capitalLanguage.includes("Fresh capital: selective / staggered only")) && capitalLanguage.includes("TRM_BLOCK_FRESH_CLASSES")],
